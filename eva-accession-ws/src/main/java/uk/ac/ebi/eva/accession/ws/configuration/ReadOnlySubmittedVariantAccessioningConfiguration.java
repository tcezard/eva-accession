...
/**
 * Line-for-line copy of {@link uk.ac.ebi.eva.accession.core.configuration.nonhuman.SubmittedVariantAccessioningConfiguration}
 * for eva-accession-ws
 */
@Configuration
// Back off entirely if the real SubmittedVariantAccessioningConfiguration already defined this bean,
// instead of colliding with it.
@ConditionalOnMissingBean(name = "submittedVariantAccessioningService")
// No @EnableSpringDataContiguousIdService here (that's what pulls in @EnableJpaRepositories, which
// needs a live EntityManagerFactory/DataSource at startup); ReadOnlyContiguousIdBlockServiceConfiguration replaces
// it with an in-memory-only ContiguousIdBlockService instead. Everything else in this @Import is unchanged.
