...
/**
 * Line-for-line copy of {@link uk.ac.ebi.eva.accession.core.configuration.nonhuman.ClusteredVariantAccessioningConfiguration}
 * for eva-accession-ws, with two differences.
 */
@Configuration
// Back off entirely if the real ClusteredVariantAccessioningConfiguration already defined this bean
// ("nonhumanActiveService"), instead of colliding with it.
@ConditionalOnMissingBean(name = "nonhumanActiveService")
// No @EnableSpringDataContiguousIdService here (because it needs a live PostgreSQL connection at
